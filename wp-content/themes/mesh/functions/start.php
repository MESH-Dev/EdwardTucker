...
function loadup_scripts() {
    ...
    wp_enqueue_style( 'main-style', get_template_directory_uri() . '/css/main.css', '10000', 'all' );
    ...
    wp_enqueue_style( 'animate', '//cdnjs.cloudflare.com/ajax/libs/animate.css/3.3.0/animate.min.css' );   
    ...
    wp_enqueue_script( 'ST', get_template_directory_uri() . '/js/jquery.localscroll-1.2.7-min.js', array( 'jquery' ), true );
    wp_enqueue_script( 'localS', get_template_directory_uri() . '/js/jquery.scrollTo-1.4.2-min.js', array( 'jquery' ), true );
